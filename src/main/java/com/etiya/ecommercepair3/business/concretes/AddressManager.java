...
public class AddressManager implements AddressService {
    ...
    @Override
    public DataResult<Slice<ListAddressResponse>> getAll(Pageable pagable) {
        return new SuccessDataResult<>(addressDao.getAll(pagable), Messages.Address.AddressGetAll);
    }

    @Override
    public DataResult<AddressDetailResponse> getAddressById(Integer id) {
        return new SuccessDataResult<>(addressDao.getByAddressId(id), Messages.Address.AddressGetById);
    }
    ...
    public DataResult<AddAddressResponse> addAddress(AddAddressRequest addAddressRequest) {
        ...
        return new SuccessDataResult<>(addAddressResponse, Messages.Address.AddressAdded);
    }
    ...
    public DataResult<UpdateAddressResponse> updateAddress(UpdateAddressRequest updateAddressRequest) {
        ...
        return new SuccessDataResult<>(updateAddressResponse, Messages.Address.AddressUpdated);
    }

    @Override
    public Result deleteAddress(Integer id) {
        addressDao.deleteById(id);
        return new SuccessResult(Messages.Address.AddressDeleted);
    }
