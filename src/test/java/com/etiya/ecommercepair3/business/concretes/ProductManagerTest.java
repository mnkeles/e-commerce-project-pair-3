...
public class ProductManagerTest {
    ...
    @Test
    void update() {
        UpdateProductRequest updateProductRequest = new UpdateOrderRequest(1,"Apple",10,10,1);
        DataResult<UpdateProductRequest> actualResponse =
                new SuccessDataResult<>(productManager.updateProduct(updateProductRequest));

        SuccessDataResult<UpdateProductRequest> expectedResponse =
                new SuccessDataResult<>(new UpdateProductRequest(1, "aa",false));
